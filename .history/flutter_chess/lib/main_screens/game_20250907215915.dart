...
class _GameScreenState extends State<GameScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    //   final opponentName = args?['opponentName'] ?? gameProvider.opponentName ?? 'Opponent';
    //   final opponentRating = args?['opponentRating'] ?? gameProvider.opponentRating ?? 1200;
    // final opponentImage = args?['opponentImage'] ?? gameProvider.opponentImage ?? '';

    // final whitesTimer = getTimerToDisplay(gameProvider: gameProvider, isUser: gameProvider.isHumanWhite);
    //   final blacksTimer = getTimerToDisplay(gameProvider: gameProvider, isUser: !gameProvider.isHumanWhite);
