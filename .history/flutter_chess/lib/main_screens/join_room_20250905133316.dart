...
class _JoinRoomScreenState extends State<JoinRoomScreen> {
  ...
  Future<void> _joinByCode() async {
    ...
    try {
      ...
      gameProvider.isHumanWhite = false;
      showSnackBar(
        context: context,
        content: 'You have joined the game against ${game['creatorName']}!',
      );
      Navigator.pushNamed(
        context,
                    ...
                    : ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return ListTile(
                            ...
                            subtitle: Text(
                              'Rating: ${game['creatorRating']} | Time: ${game['whiteTime']/60}min + ${game['increment']}s',
