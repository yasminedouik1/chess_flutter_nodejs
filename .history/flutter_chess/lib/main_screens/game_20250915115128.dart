  ...
  Widget build(BuildContext context) {
    ...
    useEffect(() {
      WidgetsBinding.instance.addPostFrameCallback((_) {
                print('Initializing GameScreen, vsComputer: ${gameProvider.vsComputer}, isPlaying: ${gameProvider.isPlaying}');
        ...
        if (gameProvider.vsComputer) {
         ...
         if (!gameProvider.isPlaying) {
          ...
          gameProvider.setSquaresState().then((_) {
            print('Multiplayer board state initialized: PlayState=${gameProvider.state.state}, Player=${gameProvider.player}');
