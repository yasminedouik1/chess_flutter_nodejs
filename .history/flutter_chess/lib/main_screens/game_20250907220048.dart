      ...
      body: Column(
        children: [
          ...
          ListTile(
            leading: CircleAvatar(
              ...
              backgroundImage: NetworkImage(
                  gameProvider.opponentImage ?? AssetsManager.userIcon),
              backgroundColor: const Color(0xFF3A3A6A),
            ),
            title: Text(
              gameProvider.opponentName ?? 'Opponent',
              style: const TextStyle(color: Colors.white),
            ),
            subtitle: Text(
              'Rating: ${gameProvider.opponentRating ?? 1200}',
              style: const TextStyle(color: Colors.grey),
            ),
            trailing: Text(
              gameProvider.isHumanWhite ? gameProvider.blacksTimer : gameProvider.whitesTimer,
          ...
          ListTile(
            ...
            trailing: Text(
              gameProvider.isHumanWhite ? gameProvider.whitesTimer : gameProvider.blacksTimer,
              style: const TextStyle(fontSize: 16, color: Colors.white),
            ),
            tileColor: const Color(0xFF3A3A6A),
            shape: RoundedRectangleBorder(
