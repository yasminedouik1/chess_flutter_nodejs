...
class GameScreen extends HookWidget {
  ...
  Widget build(BuildContext context) {
      ...
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ...
        if (gameProvider.vsComputer) {
          ...
          gameProvider.setSquaresState().then((_) {
            print('GameScreen: Multiplayer board state initialized: PlayState=${gameProvider.state.state}, Player=${gameProvider.player}, BoardSize=${gameProvider.state.board.length}, FEN=${gameProvider.getPositionFen()}');
    ...
    if (gameProvider.state.board.isEmpty) {
