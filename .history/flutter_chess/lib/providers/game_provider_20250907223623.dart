...
set gameId(String? value) {
  ...
  Move _uciToMove(String uci) {
    ...
    return Move(
      from: from,
      to: to,
      promo: promotion != null ? _pieceToString(promotion, 'w') : null,
    );
  }
...
void initSocketListeners(BuildContext context) {
    ApiService.onOpponentJoined(context, (data) {
      ...
      whitesTime = Duration(seconds: data['whiteTime']);
      blacksTime = Duration(seconds: data['blackTime']);
      isPlaying = true;
