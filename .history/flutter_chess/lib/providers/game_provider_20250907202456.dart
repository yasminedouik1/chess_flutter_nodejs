...
final gameProvider = StateNotifierProvider<GameNotifier, GameState>((ref) => GameNotifier());final fenProvider = StateNotifierProvider<FenNotifier, String>((ref) => FenNotifier());
