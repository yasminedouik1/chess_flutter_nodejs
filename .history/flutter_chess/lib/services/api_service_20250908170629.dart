...
// Join a game room via WebSocket
  static void joinGameRoom(String gameId) {
    ...
    print('Joined game room: $gameId');
  }

  // Listen for opponent joining
  static void onOpponentJoined(Function(Map<String, dynamic>) callback) {
  ...
  static void emitMove(String gameId, String move) {
    socket?.emit('make_move', {'gameId': gameId, 'move': move});
    print('Move emitted: $move for game $gameId');
  }
