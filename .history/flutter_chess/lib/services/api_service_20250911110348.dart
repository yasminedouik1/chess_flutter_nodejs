...
class ApiService {
 ...
 static Future<Map<String, dynamic>> createGame({
      ...
      if (isPrivate && joinCode != null) {  // Fix: Only include joinCode for private games
      ...
      if (response.statusCode == 201) {
        ...
        throw Exception(_safeDecode(response.body)['message'] ?? 'Failed to create game');
      }
    }
...
// Socket listener for player joined (add/replace with existing listeners)
    static void onPlayerJoined(Function(Map<String, dynamic>) callback) {
