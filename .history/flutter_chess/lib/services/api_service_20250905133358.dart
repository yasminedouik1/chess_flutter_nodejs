...
class ApiService {
  ...
  static Future saveUser(String userId, String token, String username) async {
  ...
  static Future<Map<String, dynamic>> signup({
    ...
    if (response.statusCode == 200) {
      ...
      if (userId != null && username != null && data['token'] != null) {
  ...
  static Future<List> getAvailableGames(String token) async {
  ...
  static Future cancelGame({required String token, required String gameId}) async {
